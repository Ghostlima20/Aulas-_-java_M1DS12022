...
// 
// arrayObject[0]=12;
// arrayObject[1]="webson";
// arrayObject[0]=13.8;
// arrayObject[0]=true;
// arrayObject[0]=ArrayQuakquer;
//
//  for (int aux2< arrayObject.lenght; aux2++) {
//	  sy
//  }
  
  int[][] arrayBidiricional = new int [3][3];
  for (int linha= 0; linha < arrayBidirecional[0].lenght; linha++) {
